...
const EnvSchema = z
  .object({
    ...
    SEED_USERS_COUNT: z.coerce.number().int().positive().optional().default(1000),
    DEFAULT_LIST_SIZE: z.coerce.number().int().positive().optional().default(100),
    ...
    DEFAULT_USER_BIO_SIZE: z.coerce
      ...
      .optional()
      .default(256),
    DEFAULT_DELAY_MS: z.coerce.number().int().nonnegative().optional().default(0),
    ...
    MAX_COMPUTE_ITERATIONS: z.coerce
      ...
      .optional()
      .default(50_000_000),
    DEFAULT_STREAM_CHUNKS: z.coerce.number().int().positive().optional().default(10),
    MAX_STREAM_CHUNKS: z.coerce.number().int().positive().optional().default(10_000),
